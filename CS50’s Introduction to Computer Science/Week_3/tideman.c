...
bool creates_cycle(int loser, int winner); // Declaration of creates_cycle function
...
// Helper function to check if locking a pair would create a cycle
bool creates_cycle(int loser, int winner)
{
    // Check if there's a cycle starting from the winner
    if (loser == winner)
    {
        return true;
    }
